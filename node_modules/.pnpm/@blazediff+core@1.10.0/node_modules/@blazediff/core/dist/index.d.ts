 ...
 */
declare function diff(image1: Image["data"], image2: Image["data"], output: Image["data"] | null | undefined, width: number, height: number, { threshold, alpha, aaColor, diffColor, includeAA, diffColorAlt, diffMask, fastBufferCheck, }?: CoreOptions): number;
