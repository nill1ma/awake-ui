...
function Root(props: ComponentProps<typeof BaseUIField.Root>) {
  return <BaseUIField.Root {...props} className={clsx('field-root', props.className)} />;
}

function Label(props: ComponentProps<typeof BaseUIField.Label>) {
  return <BaseUIField.Label {...props} className={clsx('field-label', props.className)} />;
}

function Control(props: ComponentProps<typeof BaseUIField.Control>) {
  return <BaseUIField.Control {...props} className={clsx('field-control', props.className)} />;
}
